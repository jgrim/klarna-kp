...
class Item implements Contracts\Model
{
    ...
    public function toArray()
    {
        return array_filter([
            ...
            'quantity_unit'         => (int)$this->getQuantityUnit(),
            'unit_price'            => $this->getUnitPrice(),
            'tax_rate'              => (int)$this->getTaxRate(),
            'total_amount'          => (int)$this->getTotalAmount(),
            'total_discount_amount' => (int)$this->getTotalDiscountAmount(),
            'total_tax_amount'      => (int)$this->getTotalTaxAmount(),
